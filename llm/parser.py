...
- name, gender("男"或"女"，无法判断则为空字符串), relation(与老人关系), personality, preferences, habits, relations, notes
- 如果 relation 是子女/儿女/孩子，请根据 gender 细分：男=儿子，女=女儿；无法判断性别时才保留子女
...
{{
  ...
  "family_profiles": [ {{ "name":"...","gender":"男或女","relation":"...","personality":[...],"preferences":[...],"habits":[...],"relations":[],"notes":"" }} ]
}}
